...
export type CloseInput<
  ...
  TAccountLildex extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountLildex>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountLildex> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.lildex),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountLildex>;
